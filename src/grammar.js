...
function peg$parse(input, options) {
  ...
  var peg$f8 = function(variable, expr) {
      return {
        type: "Assignment",
        variable: variable,
        expression: expr,
  ...
  var peg$f12 = function(digits) { return { type: "Integer", value: parseInt(digits.join(''), 10) }; };
  var peg$f13 = function(value) { return { type: "String", value: value }; };
